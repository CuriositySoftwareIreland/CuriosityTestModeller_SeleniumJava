package Utilities.TestModeller.ElementScanner;

import Utilities.TestModeller.Entities.PageObjects.PageObjectParameterEntity;
import Utilities.TestModeller.Entities.PageObjects.VipAutomationSelectorEnum;
...
public class ElementExtractor {
    ...
    public static boolean updateParameter(PageObjectParameterEntity parameter, WebElement element, WebDriver driver)
    {
        ...
        if (parameter.getParamType().equals(VipAutomationSelectorEnum.ClassName)) {
            ...
            System.out.println("Unsupported identifier - " + parameter.getParamType());
